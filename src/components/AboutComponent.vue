  ...
  <v-container fluid>
    ...
    <v-row  class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12" cols="12">
        <v-card :elevation="0">
          <img :src="require('@/assets/R+2.png')" width="100">
        </v-card>
      </v-col>
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12" cols="12">
        <v-card :elevation="0">
          <img :src="require('@/assets/R_D.png')" width="100">
        </v-card>
      </v-col>
      <v-col md="10" sm="12" cols="12">
        <v-card :elevation="0">
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12" cols="12">
        <v-card :elevation="0">
          <img :src="require('@/assets/R_S.png')" width="100">
        </v-card>
      </v-col>
      <v-col md="10" sm="12" cols="12">
        <v-card :elevation="0">
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12" cols="12">
        <v-card :elevation="0">
          <v-card-text>
            <img :src="require('@/assets/S_C.png')" width="100">
          </v-card-text>
        </v-card>
      </v-col>
      <v-col md="10" sm="12" cols="12">
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12" cols="12">
        <v-card :elevation="0">
          <v-card-text>
            <img :src="require('@/assets/S+4.png')" width="100">
          </v-card-text>
        </v-card>
      </v-col>
      <v-col md="10" sm="12" cols="12">
        ...
        <v-card :elevation="0">
          <v-card-text class="text-center text-sm-left">
            <a href="/" class="text-decoration-none">
              <img :src="require('@/assets/Uno_Logo.png')" width="50">
            </a>
          </v-card-text>
        </v-card>
      </v-col>
