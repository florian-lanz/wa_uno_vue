      ...
      <v-col md="2" sm="12">
        <v-card :elevation="0">
          <v-carousel cycle hide-delimiter-background hide-delimiters show-arrows-on-hover height="auto">
            <v-carousel-item>
              <img src="../assets/R+2.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/B+2.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/G+2.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/Y+2.png" width="100">
            </v-carousel-item>
          </v-carousel>
        </v-card>
      </v-col>
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12">
        <v-card :elevation="0">
          <v-carousel cycle hide-delimiter-background hide-delimiters show-arrows-on-hover height="auto">
            <v-carousel-item>
              <img src="../assets/R_D.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/B_D.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/G_D.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/Y_D.png" width="100">
            </v-carousel-item>
          </v-carousel>
        </v-card>
      </v-col>
    ...
    <v-row class="pl-md-16 pr-md-16 pl-sm-8 pr-sm-8">
      <v-col md="2" sm="12">
        <v-card :elevation="0">
          <v-carousel cycle hide-delimiter-background hide-delimiters show-arrows-on-hover height="auto">
            <v-carousel-item>
              <img src="../assets/R_S.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/B_S.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/G_S.png" width="100">
            </v-carousel-item>
            <v-carousel-item>
              <img src="../assets/Y_S.png" width="100">
            </v-carousel-item>
          </v-carousel>
        </v-card>
      </v-col>
